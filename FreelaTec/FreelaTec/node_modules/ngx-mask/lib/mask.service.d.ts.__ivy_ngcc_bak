...
export declare class MaskService extends MaskApplierService {
    ...
    applyMask(inputValue: string, maskExpression: string, position?: number, justPasted?: boolean, cb?: Function): string;
    private _numberSkipedSymbols;
    applyValueChanges(position: number | undefined, justPasted: boolean, cb?: Function): void;
