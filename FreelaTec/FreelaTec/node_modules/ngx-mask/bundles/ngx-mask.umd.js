(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MaskApplierService = /** @class */ (function () {
        ...
        MaskApplierService.prototype.applyMask = function (inputValue, maskExpression, position, justPasted, cb) {
    ...
    var MaskService = /** @class */ (function (_super) {
        ...
        MaskService.prototype.applyMask = function (inputValue, maskExpression, position, justPasted, cb) {
            var _this = this;
            if (position === void 0) { position = 0; }
            if (justPasted === void 0) { justPasted = false; }
            if (cb === void 0) { cb = function () { }; }
            ...
            var result = _super.prototype.applyMask.call(this, newInputValue, maskExpression, position, justPasted, cb);
        ...
        MaskService.prototype.applyValueChanges = function (position, justPasted, cb) {
            if (position === void 0) { position = 0; }
            if (cb === void 0) { cb = function () { }; }
    ...
    var MaskDirective = /** @class */ (function () {
        ...
        MaskDirective.prototype.onInput = function (e) {
            ...
            var caretShift = 0;
            var backspaceShift = false;
            this._maskService.applyValueChanges(position, this._justPasted, function (shift, _backspaceShift) {
