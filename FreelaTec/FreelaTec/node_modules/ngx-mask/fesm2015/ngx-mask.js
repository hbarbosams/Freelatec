...
class MaskApplierService {
    ...
    applyMask(inputValue, maskExpression, position = 0, justPasted = false, cb = () => { }) {
...
class MaskService extends MaskApplierService {
    ...
    applyMask(inputValue, maskExpression, position = 0, justPasted = false, cb = () => { }) {
        ...
        const result = super.applyMask(newInputValue, maskExpression, position, justPasted, cb);
    ...
    applyValueChanges(position = 0, justPasted, cb = () => { }) {
...
class MaskDirective {
    ...
    onInput(e) {
        ...
        let caretShift = 0;
        let backspaceShift = false;
        this._maskService.applyValueChanges(position, this._justPasted, (shift, _backspaceShift) => {
            this._justPasted = false;
            caretShift = shift;
